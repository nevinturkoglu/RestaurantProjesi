...
namespace RestaurantProjesi.Areas.Yonetici.Controllers
{
	...
	public class İletisimController : Controller
    {
        ...
        {
            return View(await _context.İletisimler.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var İletisim = await _context.İletisimler
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var İletisim = await _context.İletisimler.FindAsync(id);
            if (İletisim == null)
            {
                return NotFound();
            }
        ...
        {
            var İletisim = await _context.İletisimler.FindAsync(id);
            _context.İletisimler.Remove(İletisim);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.İletisimler.Any(e => e.Id == id);
        }
    }
}
